...
void EffectModuleMenuItem::SetActiveEffectModule(BaseEffectModule *effectModule) { m_effectModule = effectModule; }

void EffectModuleMenuItem::SetIsSavingData(bool isSavingData) { m_isSavingData = isSavingData; }

bool EffectModuleMenuItem::CanBeEnteredForEditing() const { return false; }
